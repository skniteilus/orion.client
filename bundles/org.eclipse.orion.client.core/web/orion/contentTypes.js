...
define([], function() {
	...
	ContentTypeService.prototype = /** @lends orion.file.ContentTypeService.prototype */ {
		...
		/**
		 * Looks up the ContentType for a file, given the Git Diff URL for the file.
		 * @param {String} diffURL
		 */
		getDiffContentType: function(diffURL) {
			// Should not be chopping up URLs here -- the Diff API should give us the metadata we need.
			var filename = diffURL.split("?")[0];
